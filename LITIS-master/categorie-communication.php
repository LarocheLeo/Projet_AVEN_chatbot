...
<body>
    ...
    <section class="intro">
        ...
        <div class="intro-container d-flex flex-column align-items-center">
            <h1 class="exclude-accessibility text" data-i18n="com_cat">Communication</h1>
            <div class="trait exclude-accessibility"></div>
            <p class="exclude-accessibility text" data-i18n="intro_com">Voici des ressources pour vous aider à utiliser les réseaux sociaux ou votre boite mail en toute facilité.</p>
        </div>
    </section>
    ...
    <section class="tutoriels">
        ...
        if ($result->rowCount() > 0) {
            echo "<div class='rdv'>";
            echo "<h2 data-i18n='mail_mess'>Mail et messagerie</h2>";
        ...
        if ($result_reseaux_sociaux->rowCount() > 0) {
            echo "<div class='rdv'>";
            echo "<h2 data-i18n='social_network'>Réseaux sociaux</h2>";
...
<?php 
        ...
        if ($result_visio->rowCount() > 0) {
            echo "<div class='rdv'>";
            echo "<h2 data-i18n='visio'>Visioconférence</h2>";
    ...
    <div class="quiz">
        ...
        <div class="texte-img-quiz">
            <div class="texte-quiz">
                <p class="fs-4 fw-medium" data-i18n="go_exo">Il est grand temps de vous exercer afin de savoir si vous avez bien suivi les ressources de la catégorie <span class="color_com" data-i18n="com_cat">communication </span>!</p>
                <button onclick="window.location.href='quiz.html?category=communication&source=categorie-communication.php'" class="btn fw-bold btn-quiz" data-i18n="go_quiz">Faire le quiz</button>
            </div>
            <div class="img-quiz">
