...
<body>
    ...
    <section class="intro">
        ...
        <div class="intro-container d-flex flex-column align-items-center">
            <h1 class="exclude-accessibility text" data-i18n="education_cat">Éducation</h1>
            <div class="trait exclude-accessibility"></div>
            <p class="exclude-accessibility text" data-i18n="intro_education">Que vous soyez élève ou parent, découvrez comment naviguer facilement sur les plateformes éducatives en ligne avec ces tutoriels pratiques.</p>
        </div>
    </section>
    ...
    <section class="tutoriels">
        ...
        if ($result_enfants ->rowCount() > 0) {
            echo "<div class='rdv'>";
            echo "<h2 data-i18n='children_ado'>Pour les enfants et les adolescents</h2>";
            echo "<div class='trait-jaune exclude-accessibility'></div>";
            echo "<div class='videos'>";
    ...
    <div class="quiz">
        ...
        <div class="texte-img-quiz">
            <div class="texte-quiz">
                <p class="fs-4 fw-medium" data-i18n="go_exo">Il est grand temps de vous exercer afin de savoir si vous avez bien suivi les ressources de la catégorie <span class="color_edu" data-i18n="education_cat">éducation </span>!</p>
                <button onclick="window.location.href='quiz.html?category=education&source=categorie-education.php'" class="btn fw-bold btn-quiz" data-i18n="go_quiz">Faire le quiz</button>
            </div>
            <div class="img-quiz">
