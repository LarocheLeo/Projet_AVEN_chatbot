...
<body>
    ...
    <section class="intro">
        ...
        <div class="intro-container d-flex flex-column align-items-center">
            <h1 class="exclude-accessibility text" data-i18n="internet_cat">Bases d'internet</h1>
            <div class="trait exclude-accessibility"></div>
            <p class="exclude-accessibility text" data-i18n="intro_internet">Apprenez à maîtriser les bases du numérique avec ces tutoriels faciles à suivre. Simplifiez votre vie numérique dès maintenant !</p>
        </div>
    </section>
    ...
    <section class="tutoriels">
        ...
        if ($result->rowCount() > 0) {
            echo "<div class='rdv'>";
            echo "<h2 data-i18n='online_management'>Gestion en ligne</h2>";
        ...
        if ($result_utilisation_systeme->rowCount() > 0) {
            echo "<div class='rdv'>";
            echo "<h2 data-i18n='systeme_use'>Utilisation système</h2>";
            echo "<div class='trait-violet exclude-accessibility'></div>";
            echo "<div class='videos'>";
    ...
    <div class="quiz">
        ...
        <div class="texte-img-quiz">
            <div class="texte-quiz">
                <p class="fs-4 fw-medium" data-i18n="go_exo">Il est grand temps de vous exercer afin de savoir si vous avez bien suivi les ressources de la catégorie <span class="color_int" data-i18n="internet_cat">bases d'internet </span>!</p>
                <button onclick="window.location.href='quiz.html?category=internet&source=categorie-internet.php'" class="btn fw-bold btn-quiz" data-i18n="go_quiz">Faire le quiz</button>
            </div>
            <div class="img-quiz">
