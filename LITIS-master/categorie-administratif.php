...
<body>
    ...
    <header id="phone-header" class="phone d-flex flex-column align-items-center bg-white fixed-top exclude-accessibility">
        ...
        <div class="phone_bot d-flex justify-content-between exclude-accessibility">
            <form class="search exclude-accessibility" action="cible2.php" method="post">
                <label for="search-input" class="visually-hidden" data-i18n="search_placeholder">Rechercher</label>
                <input type="text" id="search-input" placeholder="Rechercher..."  data-i18n="search_placeholder">
    ...
    <section class="intro">
        ...
        <div class="intro-container d-flex flex-column align-items-center">
            <h1 class="exclude-accessibility text" data-i18n="administrative_cat">Administratif</h1>
            <div class="trait exclude-accessibility"></div>
            <p class="exclude-accessibility text" data-i18n="intro_admin">Voici une liste complète de ressources pour vous aider à gérer vos tâches administratives plus facilement, sans que cela ne vous stresse.</p>
        </div>
    </section>
    ...
    <section class="tutoriels">
        ...
        if ($result->rowCount() > 0) {
            echo "<div class='rdv'>";
            echo "<h2 data-i18n='admin_step'>Démarches administratives</h2>";
    ...
    <div class="quiz">
        ...
        <div class="texte-img-quiz">
            <div class="texte-quiz">
                <p class="fs-4 fw-medium" data-i18n="go_exo">Il est grand temps de vous exercer afin de savoir si vous avez bien suivi les ressources de la catégorie <span class="color_adm" data-i18n="administrative_cat">administratif </span>!</p>
                <button onclick="window.location.href='quiz.html?category=administratif&source=categorie-administratif.php'" class="btn fw-bold btn-quiz" data-i18n="go_quiz">Faire le quiz</button>
            </div>
            <div class="img-quiz">
